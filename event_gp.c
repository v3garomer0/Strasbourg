...
void event_gp (){
  ...
  f_in->Add ("/home/gustavo/Documents/orsayData/r010_ene_gp_10.root");
  ...
  Double_t sumEneG, sumEneP1, sumEneP4, entries;
  	  ...
  	  for (Int_t j = 0; j < 25; j++)
  	    {
  	      ...
  	      //if (i==0) h_eneP[i*25 + j]->GetXaxis ()->SetRangeUser(10,15)
  	      //if (i==0) h_eneP[i*25 + j]->GetYaxis ()->SetRangeUser(0,300);
  	      h_eneP[i*25 + j]->Draw ();
